...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.pdlgc|current/StructureDefinition/xdmSourcePatientId)
...
Autres représentations du profil : [CSV](../StructureDefinition-xdmSourcePatientId.csv), [Excel](../StructureDefinition-xdmSourcePatientId.xlsx) 
