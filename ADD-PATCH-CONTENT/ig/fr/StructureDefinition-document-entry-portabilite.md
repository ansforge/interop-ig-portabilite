...
## Modèle logique: DocumentEntry Portabilité (LM) 
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.pdlgc|current/StructureDefinition/document-entry-portabilite)
...
Obligatoire : 0 élément(20 éléments obligatoire(s) imbriqué(s))
...
Autres représentations du profil : [CSV](../StructureDefinition-document-entry-portabilite.csv), [Excel](../StructureDefinition-document-entry-portabilite.xlsx) 
