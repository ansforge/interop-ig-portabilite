...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.pdlgc|current/StructureDefinition/StructureDefinition-pdlgcArchivePatient.json)
...
Other representations of profile: [CSV](../StructureDefinition-pdlgcArchivePatient.csv), [Excel](../StructureDefinition-pdlgcArchivePatient.xlsx) 
