...
## Modèle logique: XDM ActorXDS Core 
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.pdlgc|current/StructureDefinition/xdmActorXdsCore)
...
Autres représentations du profil : [CSV](../StructureDefinition-xdmActorXdsCore.csv), [Excel](../StructureDefinition-xdmActorXdsCore.xlsx) 
