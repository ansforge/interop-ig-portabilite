...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.pdlgc|current/StructureDefinition/StructureDefinition-EyeColor.json)
...
```json
{
  ...
  "name" : "EyeColor",
  "status" : "draft",
  "date" : "2026-07-02T07:13:14+00:00",
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "https://interop.esante.gouv.fr/ig/fhir/pdlgc/StructureDefinition/EyeColor"
    },
    {
