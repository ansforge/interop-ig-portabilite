...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.pdlgc|current/StructureDefinition/xdm-submission-set)
...
Autres représentations du profil : [CSV](../StructureDefinition-xdm-submission-set.csv), [Excel](../StructureDefinition-xdm-submission-set.xlsx) 
