...
* Dérivé de ce Modèle logique: [XDM AuthorDocumentEntry](StructureDefinition-xdm-author-document-entry.md) and [XDM AuthorSubmissionSet](StructureDefinition-xdm-author-submission-set.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.pdlgc|current/StructureDefinition/xdm-author)
...
Autres représentations du profil : [CSV](../StructureDefinition-xdm-author.csv), [Excel](../StructureDefinition-xdm-author.xlsx) 
