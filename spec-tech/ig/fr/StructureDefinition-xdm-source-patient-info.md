...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.pdlgc|current/StructureDefinition/xdm-source-patient-info)
...
Autres représentations du profil : [CSV](../StructureDefinition-xdm-source-patient-info.csv), [Excel](../StructureDefinition-xdm-source-patient-info.xlsx) 
