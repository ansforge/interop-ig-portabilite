...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.pdlgc|current/StructureDefinition/pdlgc-manifest)
...
Autres représentations du profil : [CSV](../StructureDefinition-pdlgc-manifest.csv), [Excel](../StructureDefinition-pdlgc-manifest.xlsx) 
