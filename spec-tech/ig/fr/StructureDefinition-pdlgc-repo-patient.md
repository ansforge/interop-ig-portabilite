...
## Modèle logique: PDLGC Répertoire Patient 
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.pdlgc|current/StructureDefinition/pdlgc-repo-patient)
...
Autres représentations du profil : [CSV](../StructureDefinition-pdlgc-repo-patient.csv), [Excel](../StructureDefinition-pdlgc-repo-patient.xlsx) 
