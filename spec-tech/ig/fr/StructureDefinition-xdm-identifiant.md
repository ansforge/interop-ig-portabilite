...
* Utilise ce/t/te Modèle logique: [XDM ActorXDS](StructureDefinition-xdm-actor-xds.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.pdlgc|current/StructureDefinition/xdm-identifiant)
...
Autres représentations du profil : [CSV](../StructureDefinition-xdm-identifiant.csv), [Excel](../StructureDefinition-xdm-identifiant.xlsx) 
