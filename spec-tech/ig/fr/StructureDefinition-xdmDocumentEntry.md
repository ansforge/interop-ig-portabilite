...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.pdlgc|current/StructureDefinition/xdmDocumentEntry)
...
Obligatoire : 0 élément(24 éléments obligatoire(s) imbriqué(s))
...
Autres représentations du profil : [CSV](../StructureDefinition-xdmDocumentEntry.csv), [Excel](../StructureDefinition-xdmDocumentEntry.xlsx) 
