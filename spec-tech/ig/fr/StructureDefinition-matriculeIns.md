...
* Utilise ce/t/te Modèle logique: [XDM ActorPatient](StructureDefinition-xdmActorPatient.md) and [XDM Identifiant](StructureDefinition-xdmIdentifiant.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.pdlgc|current/StructureDefinition/matriculeIns)
