...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.pdlgc|current/StructureDefinition/xdmEventCode)
...
Autres représentations du profil : [CSV](../StructureDefinition-xdmEventCode.csv), [Excel](../StructureDefinition-xdmEventCode.xlsx) 
