...
* Utilise ce/t/te Modèle logique: [Document Entry (LM)](StructureDefinition-DocumentEntry.md) and [SubmissionSet (LM)](StructureDefinition-SubmissionSet.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.pdlgc|current/StructureDefinition/PatientId)
...
Autres représentations du profil : [CSV](../StructureDefinition-PatientId.csv), [Excel](../StructureDefinition-PatientId.xlsx) 
