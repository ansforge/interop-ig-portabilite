...
* Use this Logical Model: [XDM DocumentEntry](StructureDefinition-xdm-document-entry.md) and [XDM SubmissionSet](StructureDefinition-xdm-submission-set.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.pdlgc|current/StructureDefinition/StructureDefinition-xdm-patient-id.json)
...
Other representations of profile: [CSV](../StructureDefinition-xdm-patient-id.csv), [Excel](../StructureDefinition-xdm-patient-id.xlsx) 
