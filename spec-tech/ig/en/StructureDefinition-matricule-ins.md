...
* Use this Logical Model: [XDM ActorPatient](StructureDefinition-xdm-actor-patient.md) and [XDM Identifiant](StructureDefinition-xdm-identifiant.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.pdlgc|current/StructureDefinition/StructureDefinition-matricule-ins.json)
...
Other representations of profile: [CSV](../StructureDefinition-matricule-ins.csv), [Excel](../StructureDefinition-matricule-ins.xlsx) 
