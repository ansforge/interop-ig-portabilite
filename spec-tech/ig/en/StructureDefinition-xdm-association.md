...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.pdlgc|current/StructureDefinition/StructureDefinition-xdm-association.json)
...
Other representations of profile: [CSV](../StructureDefinition-xdm-association.csv), [Excel](../StructureDefinition-xdm-association.xlsx) 
