...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.pdlgc|current/StructureDefinition/StructureDefinition-xdm-author-document-entry.json)
...
Other representations of profile: [CSV](../StructureDefinition-xdm-author-document-entry.csv), [Excel](../StructureDefinition-xdm-author-document-entry.xlsx) 
