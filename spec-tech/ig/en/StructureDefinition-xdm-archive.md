...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.pdlgc|current/StructureDefinition/StructureDefinition-xdm-archive.json)
...
Other representations of profile: [CSV](../StructureDefinition-xdm-archive.csv), [Excel](../StructureDefinition-xdm-archive.xlsx) 
