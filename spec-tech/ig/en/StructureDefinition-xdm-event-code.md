...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.pdlgc|current/StructureDefinition/StructureDefinition-xdm-event-code.json)
...
Other representations of profile: [CSV](../StructureDefinition-xdm-event-code.csv), [Excel](../StructureDefinition-xdm-event-code.xlsx) 
