...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.pdlgc|current/StructureDefinition/StructureDefinition-xdmSubmissionSet.json)
...
Other representations of profile: [CSV](../StructureDefinition-xdmSubmissionSet.csv), [Excel](../StructureDefinition-xdmSubmissionSet.xlsx) 
