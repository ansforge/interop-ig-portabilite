...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.pdlgc|current/StructureDefinition/StructureDefinition-xdm-document-entry.json)
...
Other representations of profile: [CSV](../StructureDefinition-xdm-document-entry.csv), [Excel](../StructureDefinition-xdm-document-entry.xlsx) 
