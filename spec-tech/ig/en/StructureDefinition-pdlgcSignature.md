...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.pdlgc|current/StructureDefinition/StructureDefinition-pdlgcSignature.json)
...
Other representations of profile: [CSV](../StructureDefinition-pdlgcSignature.csv), [Excel](../StructureDefinition-pdlgcSignature.xlsx) 
