...
* DOCUMENTATION 1..1 pdlgc-documentation "répertoire de stockage de la documentation d'export (dictionnaire de données, mapping, schémas techniques, jeu d'échantillons,...)"
* TRANSVERSE 0..1 pdlgc-archive-transverse "Archive de données transverses liées au praticien ou au cabinet (agenda, données de comptabilité, logs d'accès,...)" 
