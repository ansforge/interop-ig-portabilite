...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.pdlgc|current/StructureDefinition/archive-xdm)
...
Autres représentations du profil : [CSV](../StructureDefinition-archive-xdm.csv), [Excel](../StructureDefinition-archive-xdm.xlsx) 
